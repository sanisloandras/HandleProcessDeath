...
class DiscountBoxModificationListAdapter(
    val clickHandler: (String) -> Unit,
    val onCheckedChangedListener: (String) -> Unit
) :
    ...
    inner class DiscountBoxModificationViewHolder(val binding: DiscountBoxModificationListItemBinding) :
        ...
        init {
            binding.root.setOnClickListener {
                clickHandler((getItem(adapterPosition) as DiscountBoxModificationListItem).discountBox.id)
            }
            binding.cbIsActive.setOnClickListener {
                onCheckedChangedListener((getItem(adapterPosition) as DiscountBoxModificationListItem).discountBox.id)
            }
        }
